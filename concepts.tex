...
\begin{definition}[Parameter Interval] Let $p_{i}$ be a parameter and $a_{i},b_{i}\in P_{i},a_{i}<b_{i}$.
A $p_{i}$- interval is
\[
...
\begin{definition}[Region]A region is a set of the following form:
\[
