...
When a dependency is present between parameters, it could be
misleading to use assumption about the ``meaning'' of
parameters in order to intuitively choose an appropriate value that
optimizes objectives.  It should be also pointed
...
hardware/sofware dependencies, denoting dependencies occourring
