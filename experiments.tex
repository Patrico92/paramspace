...
\secL{ee}
Since our main focus is the embedded system design, we apply PS to a
related case study.  In this section, we briefly describe the
parameterized platform used as testbed for the experiments, the
general evaluation flow along with the high-level estimation models
and applications used as benchmarks.
