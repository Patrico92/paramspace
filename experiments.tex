...
results for the last value considered (100). Similar results have been
reported on average for the different benchmarks considered, which are
not included for space reasons. A complete resource with the whole 
