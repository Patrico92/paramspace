...
introductory work we are not explicitly focused on a deep
investigation on how these parameters can be fine tuned, nevertheless
...
values to perform the design space exploration (see Figure 
