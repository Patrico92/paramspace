...
\comment{TODO AND: c'e' un problema col mathcal, dai un'occhiata qui sotto}
...
\comment{TODO This is confirmed by results of \secR{parameter_impact}
}). 

\comment{TODO: Usare notazioni coerenti con le precedenti}
