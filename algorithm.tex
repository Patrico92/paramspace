...
As regards the performance of the proposed approach we can estimate that the
...
assigned to each macro-region should be perdiodically renegotiated, in
...
but, altough autonomous, they are not isolated; on the contrary, they
