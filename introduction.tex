...
design space exploration of embedded systems is probably the one of Evolutionary
Multiobjective Optimization Algorithms~\cite{coello_easmop}. For this
reason this is the class of algorithms that we will use for the
experiments discussed in~\secR{ee}.
