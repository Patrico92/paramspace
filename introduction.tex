...
\comment{DP: ho reintrodotto la descrizione di cos'e' un pareto set e
front che ci serve dopo quando descriviamo PS, inoltre ho sostituito
la tua frase era un po' contorta. In breve, il fatto che il pareto set
del DSE sia un'approssimazioen di quello divino irraggiungibile e' una
cosa che e' inutile dire qui, fa solo confondere col concetto di
approssimazione che e' invece dovuto al fatto che usiamo modelli di
alto livello}
...
\comment{DP: poi dobbiamo trovare un nome piu' interessante rispetto a
interesting regions, ci pensiamo questa estate}
