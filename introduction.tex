...
system parameters. \comment{Potrebbe essere pompato di piu' con qualche cosa piu' d'impatto? }

\section{Related work}
\comment{Preferisci che i related work siano in un'unica sezione con Intro?}
...
to take advantage of the parameter dependencies, a-priori known by the designer \comment{E' giusto, cosi'?}. Starting from them, he can construct a
