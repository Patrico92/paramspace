...
hardware/software dependencies has been analyzed \comment{AA: da ``carried out'' a ``analyzed'', carry out a case study (effettuare un caso studio) mi suonava strano } carried out to evaluate
