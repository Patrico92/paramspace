...
%In this work we present PS, a new multiobjective exploration algorithm
...
%multiobjective genetic technique demonstrate that, while not
...
In this work we present PS, a new multi-objective optimization algorithm and evaluate it in the context of the exploration the embedded system design space. The basic idea is to recognize \emph{interesting} regions, i.e.
